                ...
                <div className='row ' style={{ height: "100%" }}>
                    <div className="col-md-12 d-block d-lg-none p-0" style={{position:"relative"}}>
                        ...
                        <div className='w-75 text-center' style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: "4" }}>
                            ...
                            <Link className='btn btn-lg carouselBtn d-none d-sm-block mx-auto'  style={{width:"fit-content", }} to={'/contactus'}>Seek A Consultation</Link>
                            <Link className='btn btn-lg carouselBtn d-block d-sm-none mx-auto'  style={{ width:"fit-content"}} to={'/contactus'}>Explore</Link>
                        </div>
                    </div>
                    <div className="col-md-12 col-lg-6 p-0 my-auto d-none d-lg-block ">
                        <div className="mx-auto ms-lg-auto me-lg-5 p-md-4" style={{ width: "70%", color: "black" }}>
                            ...
                            <Link className='btn btn-lg  carouselBtn'to={'/contactus'}>Seek a Consultation</Link>
                        </div>
                    </div>
