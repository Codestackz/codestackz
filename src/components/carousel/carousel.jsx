                ...
                <div className='row ' style={{ height: "100%" }}>
                    <div className="col-md-12 d-block d-lg-none p-0" style={{position:"relative"}}>
                        ...
                        <div className='w-75 text-center' style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: "4" }}>
                            ...
                            <Link className='btn btn-lg btn-success border px-4 rounded-5 d-none d-sm-block mx-auto'  style={{ color: "white ", width:"fit-content", backgroundColor:"#3652AD"}} to={'/contactus'}>Seek A Consultation</Link>
                            <Link className='btn btn-lg btn-success border px-5 rounded-5 d-block d-sm-none mx-auto'  style={{ color: "white ", width:"fit-content",backgroundColor:"#3652AD"  }} to={'/contactus'}>Explore</Link>
                        </div>
                    </div>
                    <div className="col-md-12 col-lg-6 p-0 my-auto d-none d-lg-block ">
                        <div className="mx-auto ms-lg-auto me-lg-5 p-md-4" style={{ width: "70%", color: "black" }}>
                            <h1 className='fw-bold mb-4'>Web Designing and Mobile App <br /><span style={{color:"#3652AD"}}>Development Company</span></h1>
                            <p className='fw-5 fs-5 mb-xl-5 mb-lg-3 d-none d-sm-block'>Embrace innovation and elevate your company's trajectory with our specialized development solutions.</p>
                            <Link className='btn btn-lg btn-success border rounded-5 px-xl-5 px-lg-4' style={{ color: "white", backgroundColor:"#3652AD" }} to={'/contactus'}>Seek a Consultation</Link>
                        </div>
                    </div>
